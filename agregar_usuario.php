...
<?php
	if ($_POST['nombre'] && $_POST['usuario'] && $_POST['password'] && $_POST['rol']) {
		...
		if ($_SESSION["usuario_actual_rol"] === 'admin' && $_POST['Guardar']) {
			$accion = "Ingresado";
			...
			$accion = "Modificado";
			$sql = "UPDATE `usuario` SET `IdUsuario`='".$_POST['id']."',`Usuario`='".$_POST['usuario']."',`Password`='".$_POST['password']."',`Rol`='".$_POST['rol']."',`Nombre`='".$_POST['nombre']."' WHERE IdUsuario = '".$_POST['id']."'";
		}
